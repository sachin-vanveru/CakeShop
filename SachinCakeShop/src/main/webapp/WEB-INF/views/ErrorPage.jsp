...
<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.8/angular.min.js"></script>
	...
	<td>
		...
		<h3 style="font-family:cursive;color:red;">if u want this Cake for your event then kindly call on this number-022 2252147</h3>
		<h3 style="font-family:cursive;color:red;">Thank You!!!!!!</h3>
		</td>
		<td>
			<img style="height:70%;width: 70%;" alt="outofstock"  src="<c:url value='/resources/image/outofstock.jpg'/>" ">
			</td>
	  </tr>
	</table>
